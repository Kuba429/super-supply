...
export default async function Categories() {
	...
	return (
		<>
			...
			<div className="grid cursor-pointer grid-cols-5 place-items-center gap-5 p-5">
				{data.categories.map((i) => (
					<div className="flex h-40 w-full flex-col items-center rounded bg-white p-3 shadow-lg">
						<img
